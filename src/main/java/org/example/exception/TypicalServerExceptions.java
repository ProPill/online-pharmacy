...
public enum TypicalServerExceptions {
    ...
    SPECIALITY_NOT_FOUND(new ServerException(HttpStatus.NOT_FOUND, "SPECIALITY_NOT_FOUND", "SPECIALITY_NOT_FOUND")),
    SEARCH_NOT_FOUND(new ServerException(HttpStatus.NOT_FOUND, "SEARCH_NOT_FOUND", "SEARCH_NOT_FOUND")),
